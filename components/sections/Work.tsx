...
const projects: Project[] = [
  ...
  },
  {
    ...
    outcome: [
      'I translated Aibao\'s brand and mission into a clear, cohesive visual story — centered on authentic Asian food, high-quality fresh ingredients, and a warm, welcoming presence that carried across every format.',
      'I built a reusable design and copy system that made social content easy to produce while keeping branding and voice consistent across platforms, supporting weekly layout updates, content refreshes, and seasonal campaigns.',
  ...
  },
  {
    ...
    color: '#FFF7ED',
    tagline: 'Making data feel less like a spreadsheet',
    comingSoon: true,
  ...
  },
  {
    ...
    category: 'Social',
    color: '#ECFDF5',
    tagline: 'Making group plans actually happen in iMessage',
    comingSoon: true,
