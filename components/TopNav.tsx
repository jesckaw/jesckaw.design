...
export default function TopNav({
  ...
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 sm:gap-2.5 bg-white border border-black/[0.08] rounded-full px-6 py-2.5 sm:py-3 shadow-sm">
      {/* Name */}
      <button
