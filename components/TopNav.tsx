...
export default function TopNav({
  ...
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 sm:gap-3.5 bg-white border border-black/[0.08] rounded-full px-5 sm:px-6 py-2 sm:py-2.5 shadow-sm">
      {/* Name */}
      <button
